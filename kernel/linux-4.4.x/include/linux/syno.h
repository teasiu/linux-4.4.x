 ...
 */
#ifndef CONFIG_SYNO_DISK_MODEL_NUM
#define CONFIG_SYNO_DISK_MODEL_NUM 40   /* DSM 常见定义：型号字符串长度 */
#endif

#ifndef CONFIG_SYNO_DISK_MODEL_LEN
#define CONFIG_SYNO_DISK_MODEL_LEN "40" /* 注意这里要是字符串，因为用在 printk 格式里 */
#endif
/**
 * Fix: no bug entry
