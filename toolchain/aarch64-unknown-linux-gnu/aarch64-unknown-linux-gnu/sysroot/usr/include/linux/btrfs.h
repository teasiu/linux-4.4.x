...
#ifdef CONFIG_SYNO_BTRFS_DISABLE_SUBVOL_QUOTA
#define BTRFS_SUBVOL_DISABLE_QUOTA (1ULL << 35)
#endif /* CONFIG_SYNO_BTRFS_DISABLE_SUBVOL_QUOTA */
 ...
 */
#if defined(CONFIG_SYNO_BTRFS_CASELESS_STAT) || defined(CONFIG_SYNO_BTRFS_BLOCK_GROUP_HINT_TREE)
...
#endif /* CONFIG_SYNO_BTRFS_CASELESS_STAT || CONFIG_SYNO_BTRFS_BLOCK_GROUP_HINT_TREE */
...
#ifdef CONFIG_SYNO_BTRFS_CACHE_PROTECTION
...
#endif /* CONFIG_SYNO_BTRFS_CACHE_PROTECTION */
...
struct btrfs_ioctl_send_args {
	...
	__u64 reserved[2];		/* in */
#elif defined(CONFIG_SYNO_BTRFS_SEND_CALCULATE_TOTAL_DATA_SIZE) || defined(CONFIG_SYNO_BTRFS_SEND_SUPPORT_PAUSE_RESUME) 
	__u64 reserved[3];		/* in */
#else
	__u64 reserved[4];		/* in */
